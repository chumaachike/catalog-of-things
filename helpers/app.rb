...
require_relative 'create/create_book'
require_relative 'create/create_game'
require_relative 'create/create_movie'
require_relative 'create/create_music_album'
require_relative 'display/list_book'
require_relative 'display/list_movie'
require_relative 'display/list_game'
require_relative 'display/list_music_album'
require_relative 'display/list_genre'
